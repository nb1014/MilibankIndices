...
```{r load data, results='hide', fig.keep='all', message = FALSE}
...
svi_durham <- read_excel("/Users/annazolotor/Desktop/svi.xlsx")
adi_durham <- read_excel("/Users/annazolotor/Desktop/adi.xlsx")
ccvi_durham <- read_excel("/Users/annazolotor/Desktop/ccvi (1).xlsx")
coi_durham  <- read_excel("/Users/annazolotor/Desktop/COI_durham.xlsx")

# Load Chicago indices data
svi_chicago  <- read_excel("/Users/annazolotor/Desktop/Chicago_v2.xlsx", sheet="Chicago SVI")
adi_chicago  <- read_excel("/Users/annazolotor/Desktop/Chicago_v2.xlsx", sheet="Chicago ADI")
ccvi_chicago <- read_excel("/Users/annazolotor/Desktop/Chicago_v2.xlsx", sheet="Chicago CCVI")
coi_chicago  <- read_excel("/Users/annazolotor/Desktop/COI_Chicago.xlsx")

# Load NOLA indices data
svi_nola  <- read_excel("/Users/annazolotor/Desktop/nola_v2.xlsx", sheet="New Orleans SVI")
adi_nola  <- read_excel("/Users/annazolotor/Desktop/nola_v2.xlsx", sheet ="New Orleans ADI" )
ccvi_nola <- read_excel("/Users/annazolotor/Desktop/nola_v2.xlsx", sheet="New Orleans CCVI")
coi_nola <- read_excel("/Users/annazolotor/Desktop/COI_NOLA.xlsx")

# Load block group population information
durham_19ct_totalpop <- read_csv("/Users/annazolotor/Desktop/nhgis0034_ds244_20195_tract.csv") %>%
  filter(STATEA == 37 & COUNTYA==063)
us_tracts_2019 <- read_csv("/Users/annazolotor/Desktop/nhgis0034_ds244_20195_tract.csv")

# Load datasets with all indices
all_durham <- read_csv("/Users/annazolotor/Desktop/all_durham.csv")
all_cookcounty <- read_csv("/Users/annazolotor/Desktop/all_cookcounty.csv", col_types = cols(fips = col_character()))
all_nola <- read_csv("/Users/annazolotor/Desktop/all_orleans.csv", col_types = cols(fips = col_character()))
```
